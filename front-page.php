    ...
    <div class="my-slider">
        ...
        <ul>
            ...
            <li>
                ...
                <div class="banner-wrapper two" style="position: absolute;  top: 0px;">
                    <div class="text-info">
                        <div class="inner">
                            <div class="wrapper">
            ...
            <li>
                ...
                <div class="banner-wrapper three" style="position: absolute; top: 0px;">
                    <div class="text-info">
                        <div class="inner">
                            <div class="wrapper">
            ...
            <li>
                ...
                <div class="banner-wrapper four" style="position: absolute; top: 0px;">
                    <div class="text-info">
                        <div class="inner">
                            <div class="wrapper">
            ...
            <li>
                ...
                <div class="banner-wrapper five" style="position: absolute; top: 0px;">
                    <div class="text-info">
                        <div class="inner">
                            <div class="wrapper">
